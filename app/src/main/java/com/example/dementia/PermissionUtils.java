...
public abstract class PermissionUtils {
    ...
    */
   public static void requestLocationPermissions(MapsActivity activity, int requestId,
   ...
   public static void requestLocationPermissions(TrackPatientMapsActivity trackPatientMapsActivity, int locationPermissionRequestCode, boolean finishActivity) {
      if (ActivityCompat
              .shouldShowRequestPermissionRationale(trackPatientMapsActivity, permission.ACCESS_FINE_LOCATION) ||
              ActivityCompat.shouldShowRequestPermissionRationale(trackPatientMapsActivity,
                      permission.ACCESS_COARSE_LOCATION)) {
         // Display a dialog with rationale.
         PermissionUtils.RationaleDialog.newInstance(locationPermissionRequestCode, finishActivity)
                 .show(trackPatientMapsActivity.getSupportFragmentManager(), "dialog");
      } else {
         // Location permission has not been granted yet, request it.
         ActivityCompat.requestPermissions(trackPatientMapsActivity,
                 new String[]{permission.ACCESS_FINE_LOCATION, permission.ACCESS_COARSE_LOCATION},
